1. This assumes you have uploaded CentOS-8-x86_64-1905-dvd1.iso into an ISOs folder on vsphere.  Ensure the MD5sum matches, or update the MD5sum in packer.
