...
* `disk_controller_type`(string) - Set VM disk controller type. Example `pvscsi`. See [here](https://github.com/vmware/govmomi/blob/8b76b54cb73c5346b4debe85b5ee88ac69d834d5/govc/USAGE.md#devicescsiadd) for full list of possible values.
